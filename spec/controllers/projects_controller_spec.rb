...
RSpec.describe ProjectsController, type: :controller  do
  ...
  describe "GET #index" do
    ...
    context "JSON Check" do
      ...
      it "success" do
        expected = {:projects => [{:id => 1, :name => "project1", :repo_name => "testing/test", :num_of_user_stories => 0},
  ...
  describe "GET #new" do
    ...
    context "user logged in" do
      ...
      context "JSON Check" do
        ...
        it "success" do
          expected = {:projects => [{:id => nil, :name => "project3", :repo_name => "testing/test3", :num_of_user_stories => 0},
